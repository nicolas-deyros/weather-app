...
const manifest = deserializeManifest({
	hrefRoot: 'file:///C:/Users/ndeyros/dev/weather-app/',
	cacheDir: 'file:///C:/Users/ndeyros/dev/weather-app/node_modules/.astro/',
	outDir: 'file:///C:/Users/ndeyros/dev/weather-app/dist/',
	srcDir: 'file:///C:/Users/ndeyros/dev/weather-app/src/',
	publicDir: 'file:///C:/Users/ndeyros/dev/weather-app/public/',
	buildClientDir: 'file:///C:/Users/ndeyros/dev/weather-app/dist/client/',
	buildServerDir: 'file:///C:/Users/ndeyros/dev/weather-app/dist/server/',
	...
	routes: [
		...
		},
		{
			...
			routeData: {
				...
				type: 'page',
				pattern: '^\\/icons\\/?$',
				segments: [[{ content: 'icons', dynamic: false, spread: false }]],
				params: [],
				component: 'src/pages/icons.astro',
				pathname: '/icons',
				prerender: true,
				fallbackRoutes: [],
				distURL: [],
		...
		},
		{
			...
			styles: [],
			routeData: {
				route: '/api/weather.json',
				isIndex: false,
				type: 'endpoint',
				pattern: '^\\/api\\/weather\\.json\\/?$',
				segments: [
					[{ content: 'api', dynamic: false, spread: false }],
					[{ content: 'weather.json', dynamic: false, spread: false }],
				],
				params: [],
				component: 'src/pages/api/weather.json.ts',
				pathname: '/api/weather.json',
				prerender: false,
				fallbackRoutes: [],
				distURL: [],
				origin: 'project',
	...
	componentMetadata: [
		[
			'C:/Users/ndeyros/dev/weather-app/src/pages/icons.astro',
			{ propagation: 'none', containsHead: true },
		],
		[
			'C:/Users/ndeyros/dev/weather-app/src/pages/index.astro',
			{ propagation: 'none', containsHead: true },
		],
	],
	renderers: [],
	...
	entryModules: {
		...
		'\u0000@astro-page:src/pages/api/weather.json@_@ts':
			'pages/api/weather.json.astro.mjs',
		'\u0000@astro-page:src/pages/icons@_@astro': 'pages/icons.astro.mjs',
		...
		'\u0000@astrojs-manifest': 'manifest_By7kBDTI.mjs',
		'C:/Users/ndeyros/dev/weather-app/node_modules/astro/dist/assets/services/sharp.js':
			'chunks/sharp_G5QZyTy6.mjs',
		'C:/Users/ndeyros/dev/weather-app/src/pages/index.astro?astro&type=script&index=0&lang.ts':
			'_astro/index.astro_astro_type_script_index_0_lang.CkR2oOpU.js',
		'C:/Users/ndeyros/dev/weather-app/src/components/page/LocationSearch.astro?astro&type=script&index=0&lang.ts':
			'_astro/LocationSearch.astro_astro_type_script_index_0_lang.W3xgjaCQ.js',
	...
	assets: [
		'/_astro/icons.Dv8dZwlk.css',
		'/favicon-animated.html',
		'/favicon-animated.svg',
		'/favicon-gif-generator.html',
		'/favicon.svg',
		'/site.webmanifest',
		'/_astro/index.astro_astro_type_script_index_0_lang.CkR2oOpU.js',
		'/icons/index.html',
	...
	checkOrigin: true,
	serverIslandNameMap: [],
	key: 'g81AWRSdi4pBhbHV2pCAiybtT1rjpFJgWMBPKf9b7Zw=',
})
